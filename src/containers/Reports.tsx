      ...
      <div className="p-6 bg-gray-100 rounded-lg shadow-md">
        ...
        <div>
            <button
              ...
              className="my-2 bg-blue-400 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-md w-full focus:outline-none focus:ring-2 focus:ring-blue-500">Descargar reporte</button>
          </div>
        {/* Tabla de datos */}
